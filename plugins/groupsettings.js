  ...
  async (_0x25c82f, _0x4ae2c7, { smd: _0x23c42c }) => {
    try {
      ...
      if (!_0x520158) {
        ...
        return await _0x25c82f.send(
          "*_ES TEAMS_Anti_Link Succesfully set to delete links from chat!_*"
        );
      } else if (_0x520158.startsWith("warn")) {
        if (_0x7e1f39.antilink === "warn") {
          return await _0x25c82f.send(
            "*_QUEEN MAKIMA_Anti_Link already set to warn link senders!!_*"
          );
        }
        await groupdb.updateOne(
          {
        ...
        return await _0x25c82f.send(
          "*_QUEEN MAKIMA_Anti_Link set to warn and delete links!_*"
        );
      } else {
        return await _0x25c82f.send(
