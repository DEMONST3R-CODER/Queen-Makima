const {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x13cccd.isBotAdmin || !_0x13cccd.isAdmin) {
       return await _0x13cccd.reply(!_0x13cccd.isBotAdmin ? "*_I'm Not Admin In This Group" + (!_0x13cccd.isCreator ? ", QUEEN MAKIMA" : "") + "_*" : tlang().admin);
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x25d56b.isBotAdmin || !_0x25d56b.isAdmin) {
       return await _0x25d56b.reply(!_0x25d56b.isBotAdmin ? "*_I'm Not Admin In This Group" + (!_0x25d56b.isCreator ? ", QUEEN MAKIMA" : "") + "_*" : tlang().admin);
     }
     try {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x31201a.isBotAdmin || !_0x31201a.isAdmin) {
       return await _0x31201a.reply(!_0x31201a.isBotAdmin ? "*_I'm Not Admin In This Group" + (!_0x31201a.isCreator ? ", QUEEN MAKIMA" : "") + "_*" : tlang().admin);
     }
 ...
 cmd({
   ...
   try {
     ...
     await _0x5e533c.send("*Hurray,one idiot kicked out successfully😊👋@" + _0x4e844a.split("@")[0] + " Kicked Succesfully!😘*", {
       mentions: [_0x4e844a]
     });
   } catch (_0x14d7b9) {
