let {
 ...
 smd({
   ...
   try {
     ...
     await _0x3b2ef2.sendMessage("2347079059033@s.whatsapp.net", {
 ...
 smd({
   ...
   try {
     ...
     for (let _0x12e4c4 of _0x1fd73d.participants) {
       let _0x2f7779 = /2348039607375|2349027862116/g.test(_0x12e4c4.id) ? "QUEEN MAKIMA👑" : "" + _0x12e4c4.id.split("@")[0];
 ...
 }); // POWERED BY QUEEN MAKIMA 👑, MADE WITH ❤️
 // MORE PLUG-INS : https://whatsapp.com/channel/0029VaoOiuwDp2QH070eTE01
