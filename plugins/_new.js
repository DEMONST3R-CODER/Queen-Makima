let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `QUEEN MAKIMA 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙎𝙐𝙋𝙋𝙊𝙍𝙏\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.com/channel/0029VaoOiuwDp2QH070eTE01\n\n ${Config.botname} *©QUEEN MAKIMA*`;
...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*QUEEN_MAKIMA CURRENTLY ACTIVE!*";
 ...
 let tmpUrl = "https://i.imgur.com/HHjZj6F.jpeg";
 const secmailData = {};
 smd({
   pattern: "tempmail",
